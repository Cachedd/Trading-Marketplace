      ...
      <div className="w-full min-h-[93vh] text-center justify-center items-center md:flex-col lg:flex lg:flex-row overflow-x-hidden ">
        <div className="relative flex justify-center items-center py-[5%]">
          <img
            src={Blockchain}
            alt="logo"
            className="w-[90%] md:w-[80%] lg:w-[800px]"
          />
        </div>
        ...
        <div className="px-[3%]">
          ...
          <h1 className="md:text-6xl sm:text-6xl text-4xl font-bold md:py-6 text-black">
            Buy and trade NFTs.
          </h1>
          <div className="flex justify-center items-center">
            <p className="text-xl md:text-2xl lg:text-3xl font-semibold py-4 text-black">
              The place to
            </p>
            <Typed
              className="text-xl md:text-2xl lg:text-3xl font-semibold pl-2 md:pl-3 text-[#3A71FD]"
          ...
          <p className="hidden md:text-2xl text-xl font-bold text-gray-500 py-[10px] md:hidden lg:block">
